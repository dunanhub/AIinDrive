...
Этот проект создан для хакатона и используется в образовательных целях.
...
- 🐛 **Баги**: [GitHub Issues](https://github.com/dunanhub/AIinDrive/issues)
- 💡 **Предложения**: [GitHub Discussions](https://github.com/dunanhub/AIinDrive/discussions)
- 📧 **Email**: support@ai-indrive.dev (заглушка для хакатона)
